...
% something about how using bad as old makes this work...
Because each component failure rate now varies with time each
...
% need to redo this without the single rate %
The exception being
