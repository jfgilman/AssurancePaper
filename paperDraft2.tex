...
estimate reliability-related quantities of interest.

Plot with expected miles to failure for each of 3 models to show the Weibull and
exponential give very different results.



\subsubsection{Model Diagnostics}
needs new transition into this section

We will now discuss the process of choosing a final model.  The
...
\hline
Exponential   & Hierarchical Rate                 & 23022               \\
Weibull       & Hierarchical Rate                 & \textbf{18556}      \\
